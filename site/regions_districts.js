...
function init() {
  ...
  maxZoom:20,
    ...
    // Создадим балун.
    var districtBalloon = new ymaps.Balloon(map, {maxWidth:1000});
    ...
    ymaps.borders.load('RU', {
        ...
        for (var districtName in districtCollections) {
            ...
            districtCollections[districtName].events.add('click', function (event, districtName) {
                ...
                // console.log(document.getElementById("content-info").innerHTML)
